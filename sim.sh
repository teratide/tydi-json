...
python3 -m vhdeps -i vhlib -i component -i test ghdl bool_array_tc -w .
python3 -m vhdeps -i vhlib -i component -i test ghdl Int64Parser_tc -w .
python3 -m vhdeps -i vhlib -i component -i test ghdl battery_status_tc -w .
